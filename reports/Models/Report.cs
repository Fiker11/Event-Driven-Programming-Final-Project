...
namespace Reports.Models{
    ...
    public class Report{
        ...
        public ReportType ReportType{ get; set; } //type of the report only from the enum class

        [BsonRepresentation(BsonType.String)]
        public ReportStatus ReportStatus { get; set; }//status of the report only from the enum class
